...
var DwollaBtn = DwollaBtn || (function() {
    ...
    return {
        _skip: function(el) {
            if (el.nextSibling && el.nextSibling.className && el.nextSibling.className.indexOf('d-btn') !== -1) {
                return true;
            }
        ...
        createMarkup: function() {
            ...
            for (var i = 0; i < els.length; i++) {
                ...
                if (!type || typeof type == 'undefined') {
                    ...
                    if (btn_script.className.indexOf('d-btn') !== -1) {
                        return;
                    }
        ...
        registerButtons: function() {
            if (window.DwollaClickEvent != null) {
                return false;
            }
            ...
            var isDBtn = function(el, parent_el) {
                var check = function(e) {
                    return (e.className.indexOf('d-btn') !== -1) && e.nodeName == "A"
                }
        ...
        handleResponse: function() {
            if (window.DwollaResponseEvent != null) {
                return false;
            }
